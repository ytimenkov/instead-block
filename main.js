...
/******/ 	deferredModules.push(["zUnb","vendors"]);
...
/* harmony import */ var blockly_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! blockly/core */ "t/1s");
/* harmony import */ var blockly_core__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(blockly_core__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var blockly_lua__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! blockly/lua */ "pmO8");
/* harmony import */ var blockly_lua__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(blockly_lua__WEBPACK_IMPORTED_MODULE_1__);
...
__webpack_require__.r(__webpack_exports__);
// Module
var code = "<category name=\"File\" colour=\"215\">\n    <button text=\"Edit game metadata\" callbackKey=\"editMetadata\"></button>\n    <button text=\"Show Lua code\" callbackKey=\"convertToLua\"></button>\n    <button text=\"Run\" callbackKey=\"run\"></button>\n    <button text=\"Save in browser\" callbackKey=\"save\"></button>\n    <sep></sep>\n    <button text=\"Save to your computer\" callbackKey=\"download\"></button>\n    <button text=\"Load from your computer\" callbackKey=\"upload\"></button>\n</category>\n";
// Exports
...
/*!**********************!*\
  !*** ./src/files.ts ***!
  \**********************/
/*! exports provided: registerFileCallbacks, localStorageKey, loadWorkspace */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "registerFileCallbacks", function() { return registerFileCallbacks; });
...
/* harmony import */ var blockly_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! blockly/core */ "t/1s");
/* harmony import */ var blockly_core__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(blockly_core__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _instead__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./instead */ "T1M+");
...
/* harmony import */ var _objects__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./objects */ "Ij/5");
/* harmony import */ var _game_info__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./game_info */ "k+Id");
...
function resetWorkspace(workspace) {
    try {
        ...
        workspace.clear();
        _objects__WEBPACK_IMPORTED_MODULE_4__["InsteadObject"].clear();
        _objects__WEBPACK_IMPORTED_MODULE_4__["InsteadRoom"].clear();
    }
    finally {
...
function convertOrRun(run, workspace) {
    ...
    code += blockly_core__WEBPACK_IMPORTED_MODULE_0__["Lua"].workspaceToCode(workspace);
    const codeElem = document.getElementById("generatedCode");
    codeElem.innerText = code;
    if (run) {
        Object(_instead__WEBPACK_IMPORTED_MODULE_1__["runGame"])(code);
    }
    else {
...
function loadWorkspace(xml, workspace) {
    var _a, _b, _c;
    try {
        const dom = blockly_core__WEBPACK_IMPORTED_MODULE_0__["Xml"].textToDom(xml);
        ...
        blockly_core__WEBPACK_IMPORTED_MODULE_0__["Xml"].domToWorkspace(dom, workspace);
...
function saveWorkspace(workspace) {
    const xml = blockly_core__WEBPACK_IMPORTED_MODULE_0__["Xml"].workspaceToDom(workspace);
    const insteadMeta = workspace.insteadMeta;
    ...
    const text = blockly_core__WEBPACK_IMPORTED_MODULE_0__["Xml"].domToText(xml);
    return text;
}
...
function exportProject(workspace) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const code = blockly_core__WEBPACK_IMPORTED_MODULE_0__["Lua"].workspaceToCode(workspace);
        zip.file(`${gameName}/${mainFileName}.lua`, code);
        const blob = yield zip.generateAsync({ type: "blob" });
        Object(file_saver__WEBPACK_IMPORTED_MODULE_3__["saveAs"])(blob, `${gameName}.zip`);
    });
}
function importProject(workspace, input) {
    return __awaiter(this, void 0, void 0, function* () {
        const zip = yield jszip__WEBPACK_IMPORTED_MODULE_2__["loadAsync"](input);
...
function editWorkspaceMetadata(workspace) {
    return __awaiter(this, void 0, void 0, function* () {
        const insteadMeta = workspace.insteadMeta;
        const newData = yield Object(_game_info__WEBPACK_IMPORTED_MODULE_5__["showInfoDialog"])(insteadMeta);
        if (newData) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.p + "da7740faec2065d0c0e2432480abd6a2.xml");
...
/*!************************!*\
  !*** ./src/objects.ts ***!
  \************************/
/*! exports provided: InsteadObject, InsteadRoom */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "InsteadObject", function() { return InsteadObject; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "InsteadRoom", function() { return InsteadRoom; });
/* harmony import */ var _blocks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./blocks */ "/61A");
/* harmony import */ var blockly_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! blockly/core */ "t/1s");
...
function generateObjectCode(type, block) {
    ...
    const dsc = blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"].valueToCode(block, "DSC", blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"].ORDER_NONE);
    let code = type + " {\n"
        + blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"].INDENT + "nam = " + blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"].quote_(name);
    if (dsc && dsc !== "''") {
        code += ",\n" + blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"].prefixLines("dsc = " + dsc, blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"].INDENT);
    }
    ...
    for (let defBlock = block.getInputTargetBlock("DEFINITION"); defBlock; defBlock = defBlock.getNextBlock()) {
        const defCode = blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"].blockToCode(defBlock, true);
        ...
        if (defCode) {
            needNL = true;
            code += ",\n" + blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"].prefixLines(defCode, blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"].INDENT);
        }
    }
    if (needNL) {
        code += "\n";
...
function addStandardFields(type, block) {
    block.appendDummyInput()
        .appendField(type)
        .appendField(new blockly_core__WEBPACK_IMPORTED_MODULE_1__["FieldTextInput"](type), "NAME");
...
function generateReferenceCode(block, objectsContainer) {
    ...
    ;
    code += blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"].quote_(objectsContainer.getInsteadObjectName(block.getFieldValue("NAME")));
    return [code, blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"].ORDER_ATOMIC];
}
class InsteadObjectBase {
    ...
    objectLifecycleListener(event) {
        ...
        if (event.type === blockly_core__WEBPACK_IMPORTED_MODULE_1__["Events"].BLOCK_CREATE) {
        ...
        else if (event.type === blockly_core__WEBPACK_IMPORTED_MODULE_1__["Events"].BLOCK_CHANGE) {
        ...
        else if (event.type === blockly_core__WEBPACK_IMPORTED_MODULE_1__["Events"].BLOCK_DELETE) {
...
;
const InsteadObject = new InsteadObjectBase("instead_object");
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Blocks"]["instead_object"] = {
    init: function () {
        addStandardFields("Объект", this)
            .setStyle("objects_blocks");
    }
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"]["instead_object"] = function (block) {
    return generateObjectCode("obj", block);
};
class ObjectReferenceDropDown extends blockly_core__WEBPACK_IMPORTED_MODULE_1__["FieldDropdown"] {
...
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Blocks"]["instead_object_ref"] = {
    init: function () {
        addReferenceFields(this, InsteadObject, "InsteadObject")
            .setStyle("objects_blocks");
    },
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"]["instead_object_ref"] = function (block) {
    return generateReferenceCode(block, InsteadObject);
};
const InsteadRoom = new InsteadObjectBase("instead_room");
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Blocks"]["instead_room"] = {
    init: function () {
        addStandardFields("Комната", this)
            .setStyle("rooms_blocks");
    }
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"]["instead_room"] = function (block) {
    return generateObjectCode("room", block);
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Blocks"]["instead_room_ref"] = {
    init: function () {
        addReferenceFields(this, InsteadRoom, "InsteadRoom")
            .setStyle("rooms_blocks");
    },
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"]["instead_room_ref"] = function (block) {
...
/*!*****************************!*\
  !*** ./src/basic_blocks.ts ***!
  \*****************************/
/*! exports provided: selfParameterName, whatParameterName */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "selfParameterName", function() { return selfParameterName; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "whatParameterName", function() { return whatParameterName; });
/* harmony import */ var _blocks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./blocks */ "/61A");
/* harmony import */ var blockly_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! blockly/core */ "t/1s");
/* harmony import */ var blockly_core__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(blockly_core__WEBPACK_IMPORTED_MODULE_1__);
...
function generateFieldCode(type, block, name = "TEXT") {
    return type + " = " + blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"].valueToCode(block, name, blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"].ORDER_NONE);
}
...
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Blocks"]["instead_disp"] = {
    init: function () {
        defineFieldBlock("Альт. имя (disp)", this);
        this.setStyle("properties_blocks");
    }
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"]["instead_disp"] = function (block) {
    return generateFieldCode("disp", block);
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Blocks"]["instead_decor"] = {
    init: function () {
        defineFieldBlock("Декорации (decor)", this);
        this.setStyle("properties_blocks");
    }
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"]["instead_decor"] = function (block) {
    return generateFieldCode("decor", block);
};
// TODO: Fine-tune inv that it can be added only to objects, and not to a room.
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Blocks"]["instead_inv"] = {
    init: function () {
        defineFieldBlock("Инвентарь(inv) \u{1F392}", this);
        this.setStyle("properties_blocks");
    }
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"]["instead_inv"] = function (block) {
    return generateFieldCode("inv", block);
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Blocks"]["instead_act"] = {
    init: function () {
        defineFieldBlock("Действие(act) \u{1F50D}", this);
        this.setStyle("properties_blocks");
    }
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"]["instead_act"] = function (block) {
    return generateFieldCode("act", block);
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Blocks"]["instead_used"] = {
...
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"]["instead_used"] = function (block) {
    return generateFieldCode("used", block);
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Blocks"]["instead_onenter"] = {
    init: function () {
        defineFieldBlock("При входе (onenter)", this);
        this.setStyle("properties_blocks");
    }
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"]["instead_onenter"] = function (block) {
    return generateFieldCode("onenter", block);
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Blocks"]["instead_onexit"] = {
    init: function () {
        defineFieldBlock("При выходе (onexit)", this);
        this.setStyle("properties_blocks");
    }
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"]["instead_onexit"] = function (block) {
    return generateFieldCode("onexit", block);
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Blocks"]["instead_obj"] = {
    init: function () {
        defineListBlock("Объекты (obj)", this);
        this.setStyle("rooms_blocks");
    }
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"]["instead_obj"] = function (block) {
    return generateFieldCode("obj", block, "ITEMS");
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Blocks"]["instead_way"] = {
    init: function () {
        defineListBlock("Выходы (way)", this);
        this.setStyle("rooms_blocks");
    }
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"]["instead_way"] = function (block) {
    return generateFieldCode("way", block, "ITEMS");
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Blocks"]["instead_print"] = {
    init: function () {
        this.appendDummyInput()
            .appendField(new blockly_core__WEBPACK_IMPORTED_MODULE_1__["FieldDropdown"]([
            ["\u{1D45D}", "p"],
            ["\u{1D45D}\u{1D45F}", "pr"],
            ["\u{1D45D}\u{1D45B}", "pn"],
        ]), "FUN")
            .appendField(new blockly_core__WEBPACK_IMPORTED_MODULE_1__["FieldTextInput"](), "TEXT");
        this.setNextStatement(true);
        this.setPreviousStatement(true);
        this.setStyle("text_blocks");
    }
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"]["instead_print"] = function (block) {
    const fun = block.getFieldValue("FUN");
    const msg = blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"].quote_(block.getFieldValue("TEXT"));
    return fun + "(" + msg + ")\n";
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Blocks"]["instead_method0"] = {
    init: function () {
        this.jsonInit({
            "message0": "\u{1D453} %1",
            "args0": [
...
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"]["instead_method0"] = function (block) {
    let branch = blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"].statementToCode(block, "DEFINITION");
    let code = "function(" + selfParameterName + ")\n" + branch + "end";
    return [code, blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"].ORDER_HIGH];
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Blocks"]["instead_method1"] = {
    init: function () {
        this.jsonInit({
...
const whatParameterName = "what";
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"]["instead_method1"] = function (block) {
    let branch = blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"].statementToCode(block, "DEFINITION");
    let code = "function(" + selfParameterName + ", " + whatParameterName + ")\n" + branch + "end";
    return [code, blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"].ORDER_HIGH];
};
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Blocks"]["instead_return_false"] = {
    init: function () {
        this.appendDummyInput()
...
blockly_core__WEBPACK_IMPORTED_MODULE_1__["Lua"]["instead_return_false"] = function (block) {
    return "return false\n";
};
...
/*!************************!*\
  !*** ./src/toolbox.ts ***!
  \************************/
/*! exports provided: createToolBox, createInsteadTheme */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createToolBox", function() { return createToolBox; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createInsteadTheme", function() { return createInsteadTheme; });
/* harmony import */ var blockly_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! blockly/core */ "t/1s");
/* harmony import */ var blockly_core__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(blockly_core__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var data_toolbox_rooms_xml__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! data/toolbox/rooms.xml */ "xY34");
/* harmony import */ var data_toolbox_objects_xml__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! data/toolbox/objects.xml */ "dKJF");
/* harmony import */ var data_toolbox_actions_xml__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! data/toolbox/actions.xml */ "oEe+");
/* harmony import */ var data_toolbox_logic_xml__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! data/toolbox/logic.xml */ "kG+o");
/* harmony import */ var data_toolbox_menu_xml__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! data/toolbox/menu.xml */ "2mmG");
...
function createToolBox() {
    const toolbox = [
        ...
        data_toolbox_objects_xml__WEBPACK_IMPORTED_MODULE_2__["default"],
        end_cat,
        category("Комнаты", "rooms_category"),
        data_toolbox_rooms_xml__WEBPACK_IMPORTED_MODULE_1__["default"],
        end_cat,
        category("Действия", "actions_category"),
        data_toolbox_actions_xml__WEBPACK_IMPORTED_MODULE_3__["default"],
        end_cat,
        category("Условия", "logic_category"),
        data_toolbox_logic_xml__WEBPACK_IMPORTED_MODULE_4__["default"],
        end_cat,
        "<sep></sep>",
        data_toolbox_menu_xml__WEBPACK_IMPORTED_MODULE_5__["default"],
    ];
    toolbox.push("</xml>");
    return toolbox.join("");
}
function createInsteadTheme() {
    return blockly_core__WEBPACK_IMPORTED_MODULE_0__["Theme"].defineTheme("instead", {
        base: "classic",
        categoryStyles: {
            "rooms_category": {
                colour: "120"
...
/*!************************!*\
  !*** ./src/instead.ts ***!
  \************************/
/*! exports provided: initInstead, runGame */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initInstead", function() { return initInstead; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "runGame", function() { return runGame; });
/* harmony import */ var instead_js_app_game__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! instead-js/app/game */ "rvG2");
/* harmony import */ var instead_js_app_game__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(instead_js_app_game__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var instead_js_app_i18n__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! instead-js/app/i18n */ "zSbL");
/* harmony import */ var instead_js_app_i18n__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(instead_js_app_i18n__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var instead_js_app_instead__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! instead-js/app/instead */ "OLl3");
/* harmony import */ var instead_js_app_instead__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(instead_js_app_instead__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var instead_js_app_menu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! instead-js/app/menu */ "t7p3");
/* harmony import */ var instead_js_app_menu__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(instead_js_app_menu__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var instead_js_app_ui__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! instead-js/app/ui */ "klLQ");
/* harmony import */ var instead_js_app_ui__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(instead_js_app_ui__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var instead_js_app_vfs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! instead-js/app/vfs */ "pTW1");
/* harmony import */ var instead_js_app_vfs__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(instead_js_app_vfs__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var instead_js_lua_interpreter__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! instead-js/lua/interpreter */ "J1w4");
/* harmony import */ var instead_js_lua_interpreter__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(instead_js_lua_interpreter__WEBPACK_IMPORTED_MODULE_6__);
...
__webpack_require__(/*! perfect-scrollbar/jquery */ "Se41")(jquery__WEBPACK_IMPORTED_MODULE_7__);
const INSTEADjs = {
    mute: true,
    preload: true,
...
function initInstead() {
    instead_js_app_game__WEBPACK_IMPORTED_MODULE_0__["loadConfig"](INSTEADjs);
    if (INSTEADjs["translation"]) {
        instead_js_app_i18n__WEBPACK_IMPORTED_MODULE_1__["load"](INSTEADjs["translation"]);
    }
    instead_js_app_instead__WEBPACK_IMPORTED_MODULE_2__["init"]();
    instead_js_app_ui__WEBPACK_IMPORTED_MODULE_4__["init"]("#instead", instead_js_app_instead__WEBPACK_IMPORTED_MODULE_2__["handlers"]);
    instead_js_app_menu__WEBPACK_IMPORTED_MODULE_3__["init"](instead_js_app_ui__WEBPACK_IMPORTED_MODULE_4__["element"], instead_js_app_instead__WEBPACK_IMPORTED_MODULE_2__["handlers"]);
    instead_js_app_game__WEBPACK_IMPORTED_MODULE_0__["path"] = '/';
    instead_js_app_game__WEBPACK_IMPORTED_MODULE_0__["id"] = 'playground';
    instead_js_app_game__WEBPACK_IMPORTED_MODULE_0__["name"] = 'Playground';
    instead_js_app_game__WEBPACK_IMPORTED_MODULE_0__["ownTheme"] = false;
    instead_js_app_game__WEBPACK_IMPORTED_MODULE_0__["stead"] = 3;
}
function runGame(code) {
    instead_js_app_vfs__WEBPACK_IMPORTED_MODULE_5__["save"](instead_js_app_game__WEBPACK_IMPORTED_MODULE_0__["mainLua"](), code);
    instead_js_lua_interpreter__WEBPACK_IMPORTED_MODULE_6__["clear"]();
    instead_js_app_instead__WEBPACK_IMPORTED_MODULE_2__["startGame"]();
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _blocks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./blocks */ "/61A");
/* harmony import */ var _basic_blocks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./basic_blocks */ "QMjz");
/* harmony import */ var blockly_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! blockly/core */ "t/1s");
...
blockly_core__WEBPACK_IMPORTED_MODULE_2__["Blocks"]["instead_self"] = {
    init: function () {
        this.appendDummyInput()
            .appendField("себя");
...
blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"]["instead_self"] = function (block) {
    return [_basic_blocks__WEBPACK_IMPORTED_MODULE_1__["selfParameterName"], blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"].ORDER_ATOMIC];
};
blockly_core__WEBPACK_IMPORTED_MODULE_2__["Blocks"]["instead_what"] = {
    init: function () {
        this.appendDummyInput()
            .appendField("оъект");
        this.setOutput(true, ["InsteadObject", "InsteadRoom"]);
...
blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"]["instead_what"] = function (block) {
    return [_basic_blocks__WEBPACK_IMPORTED_MODULE_1__["whatParameterName"], blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"].ORDER_ATOMIC];
};
blockly_core__WEBPACK_IMPORTED_MODULE_2__["Blocks"]["instead_take"] = {
    init: function () {
...
blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"]["instead_take"] = function (block) {
    const what = blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"].valueToCode(block, "WHAT", blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"].ORDER_NONE);
    return "take(" + what + ")\n";
};
blockly_core__WEBPACK_IMPORTED_MODULE_2__["Blocks"]["instead_disable"] = {
    init: function () {
        this.appendValueInput("WHAT")
...
blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"]["instead_disable"] = function (block) {
    const what = blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"].valueToCode(block, "WHAT", blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"].ORDER_NONE);
    return "disable(" + what + ")\n";
};
blockly_core__WEBPACK_IMPORTED_MODULE_2__["Blocks"]["instead_enable"] = {
    init: function () {
        this.appendValueInput("WHAT")
...
blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"]["instead_enable"] = function (block) {
    const what = blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"].valueToCode(block, "WHAT", blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"].ORDER_NONE);
    return "enable(" + what + ")\n";
};
blockly_core__WEBPACK_IMPORTED_MODULE_2__["Blocks"]["instead_drop"] = {
    init: function () {
        this.appendValueInput("WHAT")
...
blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"]["instead_drop"] = function (block) {
    const what = blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"].valueToCode(block, "WHAT", blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"].ORDER_NONE);
    const where = blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"].valueToCode(block, "WHERE", blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"].ORDER_NONE);
    let code = "drop(" + what;
    if (where)
        code += ", " + where;
    code += ")\n";
...
blockly_core__WEBPACK_IMPORTED_MODULE_2__["Blocks"]["instead_where"] = {
    init: function () {
        this.appendValueInput("WHAT")
            .appendField("(where)")
            .setCheck("InsteadObject");
        this.appendDummyInput()
            .appendField(new blockly_core__WEBPACK_IMPORTED_MODULE_2__["FieldDropdown"]([
            ["\u{2208}", "=="],
            ["\u{2209}", "~="]
        ]), "COND");
        this.appendValueInput("WHERE")
...
blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"]["instead_where"] = function (block) {
    const cond = block.getFieldValue("COND");
    const what = blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"].valueToCode(block, "WHAT", blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"].ORDER_NONE);
    const where = blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"].valueToCode(block, "WHERE", blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"].ORDER_NONE);
    return ["where(" + what + ") " + cond + " " + where, blockly_core__WEBPACK_IMPORTED_MODULE_2__["Lua"].ORDER_ATOMIC];
};
...
/*!**************************!*\
  !*** ./src/game_info.ts ***!
  \**************************/
/*! exports provided: showInfoDialog */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showInfoDialog", function() { return showInfoDialog; });
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
function showInfoDialog(data) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            backdropDiv.innerHTML = __webpack_require__(/*! ./game_info.html */ "WfoH");
...
__webpack_require__.r(__webpack_exports__);
// Module
var code = "<block type=\"instead_room\">\n    <value name=\"DSC\">\n        <shadow type=\"text\">\n            <field name=\"TEXT\">Вы в большой комнате.</field>\n        </shadow>\n    </value>\n    <statement name=\"DEFINITION\">\n        <block type=\"instead_obj\"></block>\n    </statement>\n</block>\n<block type=\"instead_disp\">\n    <value name=\"TEXT\">\n        <shadow type=\"text\">\n            <field name=\"TEXT\">название</field>\n        </shadow>\n    </value>\n</block>\n<block type=\"instead_decor\">\n    <value name=\"TEXT\">\n        <shadow type=\"text\">\n            <field name=\"TEXT\">Детальное описание комнаты</field>\n        </shadow>\n    </value>\n</block>\n<block type=\"instead_obj\"></block>\n<block type=\"instead_way\"></block>\n<block type=\"instead_onenter\">\n    <value name=\"TEXT\">\n        <block type=\"instead_method1\">\n            <statement name=\"DEFINITION\">\n                <shadow type=\"instead_print\">\n                    <field name=\"TEXT\">вошли в \"what\"</field>\n                </shadow>\n            </statement>\n        </block>\n    </value>\n</block>\n<block type=\"instead_onexit\">\n    <value name=\"TEXT\">\n        <block type=\"instead_method1\">\n            <statement name=\"DEFINITION\">\n                <shadow type=\"instead_print\">\n                    <field name=\"TEXT\">выходите в \"what\"</field>\n                </shadow>\n            </statement>\n        </block>\n    </value>\n</block>\n\n<sep></sep>\n<block type=\"instead_method0\"></block>\n<block type=\"instead_method1\"></block>\n<block type=\"lists_create_with\"></block>\n";
// Exports
/* harmony default export */ __webpack_exports__["default"] = (code);
...
/* harmony import */ var blockly_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! blockly/core */ "t/1s");
/* harmony import */ var blockly_core__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(blockly_core__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var blockly_blocks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! blockly/blocks */ "SdJ3");
...
/* harmony import */ var blockly_msg_ru__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! blockly/msg/ru */ "90VE");
/* harmony import */ var blockly_msg_ru__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(blockly_msg_ru__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _basic_blocks__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./basic_blocks */ "QMjz");
/* harmony import */ var _objects__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./objects */ "Ij/5");
/* harmony import */ var _functions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./functions */ "igfZ");
/* harmony import */ var _instead__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./instead */ "T1M+");
/* harmony import */ var _files__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./files */ "3v1U");
/* harmony import */ var _toolbox__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./toolbox */ "SE0b");



blockly_core__WEBPACK_IMPORTED_MODULE_0__["setLocale"](blockly_msg_ru__WEBPACK_IMPORTED_MODULE_2__);
...
const workspace = blockly_core__WEBPACK_IMPORTED_MODULE_0__["inject"]("blocklyDiv", {
    toolbox: Object(_toolbox__WEBPACK_IMPORTED_MODULE_8__["createToolBox"])(),
    theme: Object(_toolbox__WEBPACK_IMPORTED_MODULE_8__["createInsteadTheme"])(),
    move: { scrollbars: true, wheel: true },
    zoom: { controls: true, },
});
Object(_files__WEBPACK_IMPORTED_MODULE_7__["registerFileCallbacks"])(workspace);
workspace.addChangeListener((e) => { _objects__WEBPACK_IMPORTED_MODULE_4__["InsteadObject"].objectLifecycleListener(e); });
workspace.addChangeListener((e) => { _objects__WEBPACK_IMPORTED_MODULE_4__["InsteadRoom"].objectLifecycleListener(e); });
if (window.localStorage[_files__WEBPACK_IMPORTED_MODULE_7__["localStorageKey"]]) {
    console.log("Loading saved workspace");
    Object(_files__WEBPACK_IMPORTED_MODULE_7__["loadWorkspace"])(window.localStorage[_files__WEBPACK_IMPORTED_MODULE_7__["localStorageKey"]], workspace);
}
else {
    console.log("Loading default workspace");
    const file = __webpack_require__(/*! data/playground.xml */ "7hEL").default;
    const client = new XMLHttpRequest();
    client.onreadystatechange = function () {
        if (this.readyState === this.DONE && this.status === 200) {
            Object(_files__WEBPACK_IMPORTED_MODULE_7__["loadWorkspace"])(this.responseText, workspace);
        }
    };
    client.open("GET", file, true);
    client.send();
}
Object(_instead__WEBPACK_IMPORTED_MODULE_6__["initInstead"])();

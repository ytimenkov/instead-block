...
export namespace lua {
  ...
  function lua_pcall(L: lua_State, nargs: number, nresults: number, errfunc: number): int;
...
export namespace lauxlib {
  ...
  function luaL_loadbuffer(L: lua.lua_State, buff: lua_String, size: number, name: string): number;
